            ...
            modelBuilder.Entity("YiAim.Cms.Blogs.Anthology", b =>
                {
                    ...
                    b.ToTable("cms_anthology", (string)null);
                });

            modelBuilder.Entity("YiAim.Cms.Blogs.AnthologyInBlog", b =>
                {
                    b.Property<long>("AnthologyId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("YiAim.Cms.Blogs.TagMap", b =>
                {
                    ...
                    b.ToTable("cms_tag_map", (string)null);
                });

            modelBuilder.Entity("YiAim.Cms.Users.AppUserThirdAuth", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("cms_user_third_auth", (string)null);
                });
            ...
            modelBuilder.Entity("YiAim.Cms.Blogs.TagMap", b =>
                {
                    ...
                    b.HasOne("YiAim.Cms.Blogs.Tag", null)
                        .WithMany("TagMaps")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
